...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       protected void loadWeatherData(){
        ...
        TheInternet net = new TheInternet();
        net.execute(location);

    }

    protected class TheInternet extends AsyncTask<String, Void,String[]>{
        @Override
        public String[] doInBackground(String ... params){
            ...
            String[] result=null;
            try{
                String jsonRe = NetworkUtils.getResponseFromHttpUrl(url);
                result = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonRe);
            }catch (Exception e){
                e.printStackTrace();
            }
            return result;
