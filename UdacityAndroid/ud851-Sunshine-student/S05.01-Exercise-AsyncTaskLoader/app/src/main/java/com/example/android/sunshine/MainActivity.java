...
// TO//DO (1) Implement the proper LoaderCallbacks interface and the methods of that interface
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String[]>, ForecastAdapterOnClickHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TO//DO (7) Remove the code for the AsyncTask and initialize the AsyncTaskLoader
    ...
    private void loadWeatherData() {
        ...
        Loader<String> locLoader = loaderManager.getLoader(WEATHER_LOADER);
        if(locLoader == null){
    ...
    // TO//DO (2) Within onCreateLoader, return a new AsyncTaskLoader that looks a lot like the existing FetchWeatherTask.
    @Override
        ...
        return new AsyncTaskLoader<String[]>(this){
            ...
            public String[] loadInBackground() {
                ...
                try {
                    ...
                    cachedJson = simpleJsonWeatherData;

                    return simpleJsonWeatherData;//the reason for String[]
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
                }
    ...
    public void onLoadFinished(Loader<String[]> loader, String[] data) {
        //like onPostExecute
        //the result is deliver result delivers it to here!
    ...
    // TO//DO (6) Remove any and all code from MainActivity that references FetchWeatherTask
