...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        uriBuilder.scheme("https").authority("www.google.com");
        ...
        openWebPage("http://www.udacity.com");//urlAsString);
