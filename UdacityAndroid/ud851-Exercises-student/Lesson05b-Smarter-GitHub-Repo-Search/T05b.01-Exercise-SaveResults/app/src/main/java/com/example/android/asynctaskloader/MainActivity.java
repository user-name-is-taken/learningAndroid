...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESUTLS_RAW_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_RESUTLS_RAW_JSON));
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        String urlDisp = (String) mUrlDisplayTextView.getText();

        // TODO (6) Using the key for the query URL, put the string in the outState Bundle
        outState.putString(SEARCH_QUERY_URL_EXTRA, urlDisp);
        ...
        outState.putString(SEARCH_RESUTLS_RAW_JSON, json);
