    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TO//DO (1) Retrieve the text from the EditText and store it in a variable
                ...
                // TO//DO (2) Use the putExtra method to put the String from the EditText in the Intent
