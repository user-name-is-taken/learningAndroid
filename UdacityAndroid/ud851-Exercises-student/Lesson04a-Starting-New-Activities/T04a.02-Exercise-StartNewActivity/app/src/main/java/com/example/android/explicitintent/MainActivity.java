    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TO//DO (1) Store ChildActivity.class in a Class object called destinationActivity
                Class destinationActivity = ChildActivity.class;

                // TO//DO (2) Create an Intent to start ChildActivity

                Intent stIntent = new Intent(context,destinationActivity);

                // TO//DO (3) Replace the Toast with code to start ChildActivity
